...
import "./components/Formulario/style.css"

// cadastrar produtos                   ( code, name, description, price e discount )
// efetivar compras                     ( Adicionar os produtos ao carrinho )
// verificar o preço final da compra
// soma de descontos
...
function App() {
  ...
  return (
    ...
    <Produtos produtos={products}></Produtos>
    </div>
  );
}
